/**
 * Autogenerated by Thrift Compiler (1.0.0-dev) DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
 * 
 * @generated
 */

package apache.thrify.demo.tutorial;

import apache.thrify.demo.shared.SharedService;
...
public class Calculator {
    ...
    public static class AsyncClient extends SharedService.AsyncClient implements AsyncIface {
        ...
        public static class zip_call extends org.apache.thrift.async.TAsyncMethodCall {
            ...
            public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
                prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage(
                                                                               "zip",
                                                                               org.apache.thrift.protocol.TMessageType.ONEWAY,
                                                                               0));
                zip_args args = new zip_args();
                args.write(prot);
                prot.writeMessageEnd();
    ...
    public static class add_args implements org.apache.thrift.TBase<add_args, add_args._Fields>, java.io.Serializable, Cloneable, Comparable<add_args> {
        ...
        public int hashCode() {
            ...
            if (present_num1) list.add(num1);

            boolean present_num2 = true;
            list.add(present_num2);
            if (present_num2) list.add(num2);
    ...
    public static class calculate_args implements org.apache.thrift.TBase<calculate_args, calculate_args._Fields>, java.io.Serializable, Cloneable, Comparable<calculate_args> {
        ...
        public int hashCode() {
            ...
            if (present_logid) list.add(logid);

            boolean present_w = true && (isSetW());
            list.add(present_w);
            if (present_w) list.add(w);
